...
assert.ok(preflightBody.includes('- 最終本番反映 remote source verification: `not-started`'));
assert.ok(preflightBody.includes('- 最終本番反映 deployment update: `not-started`'));
assert.ok(preflightBody.includes('- 最終本番反映 deployment verification: `not-started`'));
assert.ok(preflightBody.includes('- 最終本番反映 web access gate verification: `not-started`'));
...
assert.ok(deployedBody.includes('- 最終本番反映 remote source verification: `success`'));
assert.ok(deployedBody.includes('- 最終本番反映 deployment update: `success`'));
assert.ok(deployedBody.includes('- 最終本番反映 deployment verification: `success`'));
assert.ok(deployedBody.includes('- 最終本番反映 web access gate verification: `success`'));
...
assert.ok(smokeFailedBody.includes('- 最終本番反映 remote source verification: `success`'));
assert.ok(smokeFailedBody.includes('- 最終本番反映 deployment verification: `success`'));
assert.ok(smokeFailedBody.includes('- 最終本番反映 web access gate verification: `failed`'));
