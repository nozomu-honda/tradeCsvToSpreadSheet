...
const GAS_TEST_MANIFEST = Object.freeze([
  ...
  test('test_applyStagingManualHighlights_fundCashInAndReinvest_20260526_', 'staging-import'),
  ...
  test('test_stockConversionBuy_updatesHoldingAndAvg_', 'trade-calculation'),
  test('test_buildTradeRows_bookValue_foreignBuy_minusFeeTaxOnly_20260511_', 'trade-calculation'),
  test('test_buildTradeRows_bookValue_foreignBuy_multipliesFeeTaxByRate_20260515_', 'trade-calculation'),
